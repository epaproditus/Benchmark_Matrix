...
export const DEFAULT_THRESHOLDS = {
  math: {
    previous: [
      ...
      { label: "Approaches", min: 40, max: 59, color: "#2563eb" },
      { label: "Did Not Meet", min: 0, max: 39, color: "#dc2626" }
    ],
    current: [
      { label: "Masters", min: 85, max: 100, color: "#9333ea" },
      { label: "Meets", min: 65, max: 84, color: "#16a34a" },
      { label: "Approaches", min: 45, max: 64, color: "#2563eb" },
      { label: "Did Not Meet", min: 0, max: 44, color: "#dc2626" }
    ]
  },
  rla: {
    previous: [
