...
export async function GET(request: Request) {
  ...
  const mathStaarSql = getLevelSql('`STAAR MA07 Percent Score`', mathPreviousThresholds);
  const mathBenchSql = getLevelSql('`Benchmark PercentScore`', mathCurrentThresholds);

  const rlaStaarSql = getLevelSql('STAAR_Score', rlaPreviousThresholds);
  const rlaBenchSql = getLevelSql('Benchmark_Score', rlaCurrentThresholds);
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const rlaStaarSql = getLevelSql('r.STAAR_Score', rlaPreviousThresholds);
    const rlaBenchSql = getLevelSql('r.Benchmark_Score', rlaCurrentThresholds);
